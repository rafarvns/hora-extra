...
{
    /// <summary>
    /// Gerencia a movimentação FPS (WASD), corrida com stamina e rotação da câmera (Mouse).
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [SerializeField, Tooltip("Quantidade máxima de stamina.")]
        private float _maxStamina = 100f;

        [SerializeField, Tooltip("Quantidade de stamina consumida por segundo ao correr.")]
        private float _staminaDrain = 20f;

        [SerializeField, Tooltip("Quantidade de stamina recuperada por segundo ao parar de correr.")]
        private float _staminaRecovery = 15f;
        ...
        /// <summary>
        /// Valor atual de stamina, útil para UI/HUD.
        /// </summary>
        public float CurrentStamina => _currentStamina;

        /// <summary>
        /// Valor máximo de stamina, útil para UI/HUD.
        /// </summary>
        public float MaxStamina => _maxStamina;

        /// <summary>
        /// Indica se o jogador está correndo neste frame.
        /// </summary>
        ...
        /// <summary>
        /// Processa WASD, corrida e aplicação de gravidade.
        /// </summary>
        private void HandleMovement()
        {
            // 1. Captura Input do Teclado
            ...
            if (Keyboard.current != null)
            {
                ...
                wantsToRun = Keyboard.current.spaceKey.isPressed;
            }

            // 2. Direção relativa ao jogador
            Vector3 direction = transform.forward * moveInput.y + transform.right * moveInput.x;
            direction.y = 0;
            direction = direction.normalized;

            // 3. Decide velocidade atual
            float currentSpeed = _walkSpeed;

            bool hasMovementInput = moveInput != Vector2.zero;
            _isRunning = wantsToRun && hasMovementInput && _currentStamina > 0f;
